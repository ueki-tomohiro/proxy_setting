...
TEST(BrowserSettingPlugin, CanLaunchSuccessTrue) {
  ...
  BrowserSettingPlugin plugin(std::move(system));
...
TEST(BrowserSettingPlugin, CanLaunchQueryFailure) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
  std::unique_ptr<MockMethodResult> result =
      std::make_unique<MockMethodResult>();
...
TEST(BrowserSettingPlugin, CanLaunchHandlesOpenFailure) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
  std::unique_ptr<MockMethodResult> result =
      std::make_unique<MockMethodResult>();
...
TEST(BrowserSettingPlugin, LaunchSuccess) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
  std::unique_ptr<MockMethodResult> result =
      std::make_unique<MockMethodResult>();
...
TEST(BrowserSettingPlugin, LaunchReportsFailure) {
  std::unique_ptr<MockSystemApis> system = std::make_unique<MockSystemApis>();
  std::unique_ptr<MockMethodResult> result =
      std::make_unique<MockMethodResult>();
